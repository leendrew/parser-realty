...
Revision ID: 77ec061efdfe
Revises: 
Create Date: 2024-08-22 21:16:47.702941
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_users_search_links_search_link_id'), 'users_search_links', ['search_link_id'], unique=False)
